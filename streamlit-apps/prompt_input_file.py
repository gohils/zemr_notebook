...
def extract_table_details(prompt, sql_script):
    messages = [
        {"role": "user", "content": f"{prompt}\n use the following contents as input :\n{sql_script}"}
    ]
    ...
    try:
        ...
        print("Error in extract_table_details:", e)
        return
    ...
    if uploaded_file is not None:
        ...
        if st.button("Process Input"):
            with st.spinner("Processing Input..."):
                ...
                details_text = extract_table_details(prompt, sql_script_content)
